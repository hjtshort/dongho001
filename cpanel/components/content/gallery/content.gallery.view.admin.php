...
<div class="page-breadcrumbs breadcrumbs-fixed">
    <div class="buttons-task col-xs-12 col-md-4">
        <ul class="breadcrumb breadcrumbs-fixed">
            ...
            <li class="toast-title">Danh sách ảnh trình diển</li>
        </ul>
    </div>
     ...
     <div class="col-xs-12 col-md-12">
         <div class="widget">
             <div class="widget-header with-footer">
                 <span class="widget-caption">Quản lý ảnh</span>
                         ...
                         <div id="simpledatatable_wrapper">
                             ...
                             <table class="table table-hover table-bordered table-striped table-condensed flip-content">
                                 ...
                                 <tr>
                                     ...
                                     <th>Tiêu đề</th>
                                     <th class="center" style="width: 10%;">Liên kết</th>
                                 ...
                                 <tbody>
                                     ...
                                     <tr class="selectable">
                                         ...
                                         <td>
                                             <input type="text" style="width: 50px; margin-bottom:0px" value="999">
                                         </td>
                                         <td class="center">
                                            Đã sử dụng
                                         </td>
