        ...
        <div class="page-breadcrumbs breadcrumbs-fixed">
            <div class="buttons-task col-xs-12 col-md-6">
                <ul class="breadcrumb breadcrumbs-fixed">
                    ...
                    <li class="toast-title">Thêm tin tức</li>
                </ul>
            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="widget flat">
                                ...
                                <div class="widget-body widget-body-white">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <i class="fa fa-question-circle tooltip-info sky" data-toggle="tooltip" data-placement="right" data-original-title="Tiêu đề bản tin"></i>
                                        <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="news_detail">Nội dung chi tiết <span class="text-danger">*</span> <i
                        ...
                        <div class="col-lg-4 col-sm-4 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-6 col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <label>
                                                        <input name="news_focus" id="news_focus" value="1" class="checkbox-slider colored-blue" type="checkbox">
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <label>
                                                        <input checked name="news_display"  value="1" class="checkbox-slider colored-blue" type="checkbox">
                                                        <span class="text"></span>
                                                    </label>
                                                </div>
                                            </div>
                            ...
                            <div class="widget flat">
                                ...
                                <div class="widget-body widget-body-white">
                                    <div class="form-group">
                                        <label for="parent_category">Danh mục tin <span class="text-danger">*</span> <i
                                                    class="fa fa-question-circle tooltip-info sky" data-toggle="tooltip"
                                                    data-placement="top"
                                                    data-original-title="Lựa chọn danh mục chứa tin tức"></i></label>
                                        <div>
                            ...
                            <div class="widget flat">
                                ...
                                <div class="widget-body widget-body-white">
                                    ...
                                    <div class="form-group">
                                        <label for="image_note">Chú thích cho ảnh <i
                                                    class="fa fa-question-circle tooltip-info sky" data-toggle="tooltip"
                                                    data-placement="top"
                                                    data-original-title="Ghi nội dung chú thích cho ảnh tại đây"></i></label>
                                        <div>
                                            <input name="image_note" type="text" id="image_note" class="form-control">
                                        </div>
                                    </div>
