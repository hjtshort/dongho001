...
if( isset($_SESSION["wti"]) || !empty($_SESSION["wti"]) ){
	...
	switch ( $conf['geturl']['view'] ) {
		...
		case "":
            include_once("index/admin.index.view.admin.process.php");
        ...
        case "domain":
            ...
            switch ( $conf['geturl']['act'] ) {
                ...
                case "view":
                    include_once("domain/admin.domain.view.admin.process.php");
                    include_once("domain/admin.domain.view.admin.php");
                    break;
