        ...
        <div class="page-breadcrumbs breadcrumbs-fixed">
            <div class="buttons-task col-xs-12 col-md-6">
                <ul class="breadcrumb breadcrumbs-fixed">
                    ...
                    <li><a href="template/category/view.html">Quản lý Danh mục</a></li>
                    <li class="toast-title">Thêm Danh mục</li>
                </ul>
            </div>
            <div class="text-align-right text-align-left-xs col-xs-12 col-md-6">
                <a href="template/category/view.html" class="btn btn-sky shiny">Hủy</a>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <?php else: ?>
                                                            <img id="image_file" style="height:180px;" class="img-thumbnail" alt="150x150" src="<?= '/'.$conf['data_user'].'/file_upload/images/'.$data["hinhanh"]; ?>">
                                                        <?php endif; ?>
                                                        <input value="<?= '/'.$conf['data_user'].'/file_upload/images/'.$data["hinhanh"]; ?>" type="hidden" name="image_src" id="image_src">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div>
