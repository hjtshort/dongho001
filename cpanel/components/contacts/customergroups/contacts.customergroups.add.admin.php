        ...
        <div class="page-breadcrumbs breadcrumbs-fixed">
            <div class="buttons-task col-xs-12 col-md-6">
                <ul class="breadcrumb breadcrumbs-fixed">
                    ...
                    <li><a href="contacts/customergroups/view.html">Danh mục nhóm khách hàng</a></li>
                        ...
                        <div class="col-lg-8 col-sm-8 col-xs-12">
                            <div class="widget flat">
                                <div class="widget-header bordered-bottom bordered-themeprimary">
                                    <span class="widget-caption">Thêm mới thông tin nhóm khách hàng</span>
                                ...
                                <div class="widget-body widget-body-white">                                                                                        
                                  <div class="form-group">
                                        ...
                                        <label for="inputTitle">Tên nhóm <span class="text-danger">*</span> <i
                                                    class="fa fa-question-circle tooltip-info sky" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="Tên nhóm khách hàng. Ví dụ:Nhóm khách hàng chung,.."></i></label>
                                        <div>
                                            <input name="news_title" type="text" id="inputTitle" class="form-control" value="Khách hàng ưu tiên">
                                    ...
                                    <div class="form-group">
                                        <label>
                                            ...
                                            <span class="text">Nhóm mặc định</span>      
                                        </label>
                                    </div>                              
                                </div>
                            </div>
