    ...
    <div class="page-breadcrumbs breadcrumbs-fixed">
        <div class="buttons-task col-xs-12 col-md-4">
            <ul class="breadcrumb breadcrumbs-fixed">
                ...
                <li class="toast-title">Danh mục nhóm khách hàng</li>
            </ul>
        </div>
        <div class="text-align-right text-align-left-xs col-xs-12 col-md-8">
            <a href="contacts/customergroups/add.html" class="btn btn-sky shiny">Thêm mới</a>
        </div>
    </div>
     <!-- Page Body -->
     <div class="page-body">
         ...
         <div class="col-xs-12 col-md-12">
             <div class="widget">
                 <div class="widget-header with-footer">
                     <span class="widget-caption">Khách hàng</span>
                             ...
                             <div id="simpledatatable_wrapper">
                                 ...
                                 <table class="table table-hover table-bordered table-striped table-condensed flip-content">
                                     ...
                                     <tr>
                                         ...
                                         <th>Tên nhóm</th>
                                         <th class="center" style="width: 10%;">Giảm giá</th>
                                         <th class="center" style="width: 10%;">Drag</th>
                                         <th style="width: 10%;" class="center">Phương thức</th>
                                         <th style="width: 7%;" class="center">Mặc định</th>
