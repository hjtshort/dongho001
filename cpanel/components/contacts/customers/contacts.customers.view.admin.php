    ...
    <div class="page-breadcrumbs breadcrumbs-fixed">
        <div class="buttons-task col-xs-12 col-md-4">
            <ul class="breadcrumb breadcrumbs-fixed">
                ...
                <li class="toast-title">Danh sách khách hàng</li>
            </ul>
        </div>
        <div class="text-align-right text-align-left-xs col-xs-12 col-md-8">
            <a href="contacts/customers/add.html" class="btn btn-sky shiny">Thêm mới</a>
        </div>
    </div>
     <!-- Page Body -->
     <div class="page-body">
