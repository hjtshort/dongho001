...
<div class="page-content">
    ...
    <div class="page-breadcrumbs breadcrumbs-fixed">
        ...
        <div class="text-align-right text-align-left-xs col-xs-12 col-md-8">
            <a href="product/category/add.html" class="btn btn-sky shiny">Thêm Danh mục</a>
        </div>
    </div>
    <!-- /Page Breadcrumb -->
    <!-- Page Body -->
                                    ...
                                    <table class="table table-hover table-bordered table-striped table-condensed flip-content">
                                        ...
                                        foreach($category as $key => $row): @$i++;?>
                                            <tr class="selectable">
                                                ...
                                                <td><a href="product/category/edit/<?= $row["danhmuc_id"]; ?>.html"><?= $row["level"] , $row["tieude"]; ?></a></td>
                                                <td><?= $row["tomtat"]; ?></td>
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <a class="btn_submit" title="sao chép Danh mục"
                                                                   ...
                                                                   data-link="product/category/copy/<?= $row["danhmuc_id"]; ?>.html">Sao
                                                                    Chép</a>
                                                            </li>
                                                            <?php if ($func->_checkIdinArray($chucnang_id_sua, $chucnang_list)): ?>
                                                                <li>
                                                                    <a class="btn_submit" title="Sửa"
                                                                       data-action="edit"
                                                                       data-id="<?= $row["danhmuc_id"]; ?>"
                                                                       data-link="product/category/edit/<?= $row["danhmuc_id"]; ?>.html">Sửa</a>
                                                                </li>
                                                            <?php endif; ?>
