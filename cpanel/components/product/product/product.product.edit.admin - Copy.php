    ...
    <div id="wrapper">		
        <div id="content">
            ...
            <div class="heading-buttons">
                <h3 class="glyphicons cart_in"><i></i> Cập nhật sản phẩm</h3>
            ...
            <div class="widget widget-2 widget-tabs">
                <div class="widget-head">
                    <ul>
                        ...
                        <li><a href="#productPriceTab" data-toggle="tab" class="glyphicons cogwheel"><i></i>Tuy chọn</a></li>
                  ...
                  <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="productDescriptionTab">
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                	<div class="controls">
                                        <input value="<?= $data["tensanpham"]; ?>" name="product_name" type="text" id="product_name" class="span6" />
                          	...
                          	<div class="row-fluid">
                                ...
                                <div class="span9">
                                    <input value="<?= $data["masanpham"]; ?>" name="product_code" type="text" id="product_code" class="span6" />
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <input value="<?= number_format($data["gia"], 0, ",", ","); ?>" name="product_price" type="text" id="product_price" class="span2 moneyformat" />
                            ...
                            <div class="row-fluid" id="div_retailprice" style="display: none;">
                                ...
                                <div class="span9">
                                    <input value="<?= number_format($data["giathitruong"], 0, ",", ","); ?>" type="text" name="product_price_market" id="product_price_market" class="span2 moneyformat" />
                            ...
                            <div class="row-fluid" id="div_saleprice" style="display: none;">
                                ...
                                <div class="span9">
                                    <input value="<?= number_format($data["giakhuyenmai"], 0, ",", ","); ?>" type="text" name="product_price_promo" id="product_price_promo" class="span2 moneyformat" />
                                    ...
                                    Hoặc giảm&nbsp;<input value="<?= $data["phantramgiam"]; ?>" name="product_percent_discount" type="text" id="inputTitle" class="span1 intformat" />&nbsp;&nbsp;%</font>
                            ...
                            <div class="row-fluid" id="div_costprice" style="display: none;">
                                ...
                                <div class="span9">
                                    <input value="<?= number_format($data["giagoc"], 0, ",", ","); ?>" type="text" name="product_price_cost" id="product_price_cost" class="span2 moneyformat" />
                                    <span class="icon-question-sign" data-toggle="tooltip" data-placement="right" title="Giá sản phẩm nhập vào từ nhà cung cấp, không hiện trên website"></span>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                					<input value="1" name="include_vat" id="include_vat" type="checkbox" class="checkbox" <?php if($data["dabaogomvat"]){ echo "checked"; }?> />
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                <input value="<?= $data["donvitinh"]; ?>" type="text" name="product_unit" id="product_unit" class="span2" />                                  
                              </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span3">	
                                ...
                                <div class="span5">
                                    <label class="groupcheckbox">
                                        <input name="product_display" id="product_display" type="checkbox" class="checkbox" <?php if($data["hienthi"]){ echo "checked"; }?> > &nbsp; 
                                        (Chọn mục này nếu bạn muốn ẩn / hiện sản phẩm)
                                    </label>                                   
                                </div>
                            </div>                           
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <textarea name="product_desc"><?= $data["motangan"]; ?></textarea>
                                    <script type="text/javascript">
                                        CKEDITOR.replace( 'product_desc' , {width : '95%', height : '150px', toolbar : 'Basic'});
                                    </script>                                    
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
									...
									<script type="text/javascript">
                                        CKEDITOR.replace( 'product_detail' , {width : '95%', height : '400px', toolbar : 'Full'});
                                    </script>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row-fluid"><br>
                                <div style="width:94.452991%;margin-left: 2.7%;">
                                    <table id="tbl_product_image" class="table table-bordered table-condensed table-striped table-primary table-vertical-center checkboxs js-table-sortable ui-sortable">
                                        ...
                                        <tbody>
                                        	<?php
												$hinhanh = unserialize($data["hinhanh"]);
												$img_row = count($hinhanh["hinhanh"]["image_src"]);
                                            ...
                                            <?php } else { 										
												for($i = 0; $i < $img_row; $i++){
													if(!empty($hinhanh["hinhanh"]["image_src"][$i])){ ?>
                                            	<tr class="selectable">
                                                    <td class="center uniformjs"><input class="chkItem" name="chkImg[]" type="checkbox"></td>
                                                    <td class="center">
                                                        <img id="image_file_<?= $i; ?>" style="height:80px;border:1px solid #ddd" src="<?= $hinhanh["hinhanh"]["image_src"][$i]; ?>">
                                                        <input type="hidden" class="image_file" name="image_src[]" value="<?= $hinhanh["hinhanh"]["image_src"][$i]; ?>" />
                                                    </td>
                                                    <td><input type="text" name="product_image_desc[]" class="span12" value="<?= $hinhanh["hinhanh"]["product_image_desc"][$i]; ?>" /></td>
                                                    <td class="center"><input value="<?= $i; ?>" type="radio" id="rdoImageMain" name="choose[]" class="checkbox" <?php if($hinhanh["hinhanh"]["choose"][0] == $i){ echo "checked"; } ?> /></td>
                                                    <td class="center js-sortable-handle"><span class="glyphicons btn-action single move" style="margin-right: 0;"><i></i></span></td>
                                                    <td class="center">
                                                        <a onclick="removeRowFromTable('tbl_product_image', <?= $i; ?>);return false;" href="javascript:void(0);" class="btn-action glyphicons remove_2 btn-danger"><i></i></a>
                                                    </td>
                                                </tr>
											<?php }
												}
                        ...
                        <div class="tab-pane" id="productInfomationTab">
                         	<div class="row-fluid">
                                ...
                                <div class="span5"><br>
                                    <select class="span6" name="IsAllowPurchase" id="IsAllowPurchase" onchange="javascript:IsDisplayPurchase();">
                                    	<?php		
											$purchase = array(		
												array("allow", "Cho phép đặt hàng"),
												array("disallow", "Chỉ hiển thị sản phẩm không cho phép đặt hàng"),
												array("disallowandtext", "Không cho phép đặt hàng hiển thị chữ thay thế")
											);
											for($i=0; $i < count($purchase); $i++){ ?>
												<option <?php if( $purchase[$i][0] == $data["chophepdathang"] ) { echo "selected"; } ?> value="<?= $purchase[$i][0]; ?>"><?= $purchase[$i][1]; ?></option>
										<?php } ?>
										</select>  
                                    </select>
                                    ...
                                    <div style="margin-left: 15px; margin-top: 0px; display: none;" id="divCallForPricingLabel">
                                        <img style="vertical-align: middle;float: left;position: relative; top: 6px;right: 3px;" alt="" src="<?php echo $template_admin; ?>/html/images/nodejoin.gif" />
                                        <label style="float:left" class="muted">Chữ hiển thị thay thế:&nbsp;&nbsp;
                                            <input value="<?= $data["chuthaythegia"]; ?>" name="CallForPricingLabel" type="text" id="CallForPricingLabel" />
                                             &nbsp; ( VD: Liên hệ )
                                        </label>
                                    </div>                                    
                                </div>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <textarea name="quaranty" class="span6" rows="5"><?= $data["noidungbaohanh"]; ?></textarea>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span5">
                                    <select class="span6" name="product_old_new">
                                    	<?php		
											$product_old_new = array(		
												array("new", "Hàng mới"),
												array("old", "Hàng đã sử dụng")
											);
											for($i=0; $i < count($product_old_new); $i++){ ?>
												<option <?php if( $product_old_new[$i][0] == $data["tinhtrang"] ) { echo "selected"; } ?> value="<?= $product_old_new[$i][0]; ?>"><?= $product_old_new[$i][1]; ?></option>
										<?php } ?>                                  
                                    </select>&nbsp;&nbsp;
                                    <input value="1" type="checkbox" class="checkbox" name="product_old_new_display" <?php if($data["hienthitinhtrang"]){ echo "checked"; } ?> />
                            ...
                            <div class="row-fluid">
                            	...
                            	<div class="span5">
                                    <div class="groupcheckbox">
                                        <input <?php if( $func->_checkIdinArray( 1, $data["tuychonnhomhienthi"] ) ){ echo "checked"; } ?> value="1" type="checkbox" class="checkbox" name="product_option_group[]" /> Nổi bật&nbsp;&nbsp;
                                        <input <?php if( $func->_checkIdinArray( 2, $data["tuychonnhomhienthi"] ) ){ echo "checked"; } ?> value="2" type="checkbox" class="checkbox" name="product_option_group[]" /> Mới&nbsp;&nbsp;
                                        <input <?php if( $func->_checkIdinArray( 3, $data["tuychonnhomhienthi"] ) ){ echo "checked"; } ?> value="3" type="checkbox" class="checkbox" name="product_option_group[]" /> Bán chạy&nbsp;&nbsp;
                                        <input <?php if( $func->_checkIdinArray( 4, $data["tuychonnhomhienthi"] ) ){ echo "checked"; } ?> value="4" type="checkbox" class="checkbox" name="product_option_group[]" id="IsPromotional" onclick="javascript:IsDisplayPromotionContent();"/> Khuyến mãi
                                        <span class="icon-question-sign" data-toggle="tooltip" data-placement="right" title="Lựa chọn 1 trong 3 tình trạng của sản phẩm, tích lựa chọn 'hiển thị tình trạng này' nếu muốn thông tin hiển thị trên website."></span>
                                    </div>                                    
                                </div>
                            </div>
                            <div class="row-fluid" id="pPromotionContent" style="display:none">
                                ...
                                <div class="span9">
                                    <textarea name="txtPromotionContent" class="span6" rows="3" id="txtPromotionContent"><?= $data["noidungnhomkhuyenmai"]; ?></textarea>                                    
                                </div>
                            </div>
                                ...
                                <div class="span9">                        
                                    <div>
                                        <div class="input-append" style="float:left">
                                            <input type="text" name="dateRangeFrom" id="dateRangeFrom" class="input-mini" value="<?= date("d/m/Y", $data["ngaybatdaukhuyenmai"] ); ?>" style="width: 70px; float:left" />
                                        ...
                                        <div class="input-append" style="vertical-align: middle;float: left;position: relative;right: -27px;">
                                            <input type="text" name="dateRangeTo" id="dateRangeTo" class="input-mini" value="<?= date("d/m/Y", $data["ngayketthuckhuyenmai"] ); ?>" style="width: 70px;" />
                                            <span class="add-on glyphicons calendar"><i></i></span>
                                        </div>
                                    </div>                                    
                                </div>
                            ...
                            <div class="row-fluid">
                                 ...
                                 <div class="span5">
                                    <select class="span5" name="manufacturers">
										...
										?> 
                                        <option <?php if( $data["nhasanxuat_id"] == $row["nhasanxuat_id"] ){ echo "selected"; } ?> value="<?= $row["nhasanxuat_id"]; ?>"> <?= $row["nhasanxuat"]; ?> </option>                                  	
                                        <?php } ?>
                                    </select>                                
                                 </div>
                            </div>    
                            ...
                            <div class="row-fluid">
                            	...
                            	<div class="span7">
                                    ...
                                    <table id="tbl_product_properties" class="table js-table-sortable ui-sortable">                                   
                                        <tbody>
                                        	<?php 
												$tuychon_ten 	= unserialize($data["tuychon_ten"]);
												$tuychon_giatri = unserialize($data["tuychon_giatri"]);
												for($i = 0; $i <count($tuychon_ten); $i++){
													if(!empty($tuychon_ten[$i])){
											?>
                                            <tr>
                                                <td style="border:none;padding:0px;">
                                                    <div class="group_row_properties">
                                                        <input value="<?= $tuychon_ten[$i]; ?>" name="product_properties_name[]" type="text" style="width:36%" />
                                                        &nbsp;&nbsp;&nbsp;<input value="<?= $tuychon_giatri[$i]; ?>" name="product_properties_value[]" type="text" class="span7" />
                                                    </div>
                                                </td>
                        ...
                        <div class="tab-pane" id="productSeoTab">
                            <div class="row-fluid">
                                ...
                                <div class="span9"><br>
                                	<input value="<?= $data["seo_tieudetrang"]; ?>" name="product_seo_title" type="text" id="inputTitlePage" class="span6" />
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <input value="<?= $data["seo_thetukhoa"]; ?>" name="product_seo_keyword" type="text" id="inputKeyword" class="span6" />
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <input value="<?= $data["seo_themota"]; ?>" name="product_seo_desc" type="text" id="inputDescrip" class="span6" />
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <input value="<?= $data["tags"]; ?>" name="product_tags" type="text" id="select2_5" class="span6" />&nbsp;
                                    <span class="icon-question-sign" data-toggle="tooltip" data-placement="right" title="Nhập tên tag, ấn Enter để thêm tag. Những gợi ý hiện ra là những tag đã có trên website của bạn, bạn có thể chọn để sử dụng."></span>
                                    <div class="separator bottom"></div>
                                    <div class="separator bottom"></div>
                                    <div class="separator bottom"></div>
