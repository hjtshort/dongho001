    ...
    <div class="page-breadcrumbs breadcrumbs-fixed">
        <div class="buttons-task col-xs-12 col-md-4">
            <ul class="breadcrumb breadcrumbs-fixed">
                ...
                <li class="toast-title">Đánh gia,phản hồi về sản phẩm</li>
            </ul>
        </div>
    </div>
     <!-- Page Body -->
         ...
         <div class="col-xs-12 col-md-12">
             <div class="widget">
                 <div class="widget-header with-footer">
                     <span class="widget-caption">Đánh gia,phản hồi về sản phẩm</span>
                             ...
                             <div id="simpledatatable_wrapper">
                                 ...
                                 <table class="table table-hover table-bordered table-striped table-condensed flip-content">
                                     ...
                                     <tr>
                                         ...
                                         <th> </th>
                                         <th class="center" style="width: 20%;">Sản phẩm</th>
                                         <th class="center" style="width: 10%;">Đánh giá</th>
                                         <th style="width: 10%;" class="center">Người gửi</th>
                                         <th style="width: 10%;" class="center">Ngày gửi</th>
                                     ...
                                     <tbody>
                                         ...
                                         <tr class="selectable">
                                             ...
                                             <td>
                                                Chương trình khuyến mãi mừng phiên bản 4.2
                                             </td>
                                             <td>
                                                012345566
                                             </td>
