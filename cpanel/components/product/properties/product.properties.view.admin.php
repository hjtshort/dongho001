    ...
    <div class="page-breadcrumbs breadcrumbs-fixed">
        <div class="buttons-task col-xs-12 col-md-4">
            <ul class="breadcrumb breadcrumbs-fixed">
                ...
                <li class="toast-title">Thuộc tính sản phẩm</li>
            </ul>
        </div>
        <div class="text-align-right text-align-left-xs col-xs-12 col-md-8">
            <a href="product/properties/add.html" class="btn btn-sky shiny">Thêm mới</a>
        </div>
    </div> 
    <div class="page-body">
        <div class="row">
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header with-footer">
                        <span class="widget-caption">Thuộc tính sản phẩm</span>
                                ...
                                <div id="simpledatatable_wrapper">
                                    ...
                                    <table class="table table-hover table-bordered table-striped table-condensed flip-content">
                                        ...
                                        <tr>
                                            ...
                                            <th class="center" style="width: 10%;">Mô tả</th>
                                            <th class="center" style="width: 10%;">Mặc định</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="selectable">
                                                ...
                                                <td class="center"><input type="text" style="width: 50px; margin-bottom:0px;text-align:center;" value="1" name="sort[]"></td>
                                                <td class="center">
                                                    <div class="btn-group">
                                                        <button type="button"
