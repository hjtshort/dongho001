...
<div class="page-content">
    ...
    <div class="page-breadcrumbs breadcrumbs-fixed">
        ...
        <div class="text-align-right text-align-left-xs col-xs-12 col-md-8">
            <a href="seo/coupons/add.html" class="btn btn-sky shiny">Thêm mới</a>
        </div>
    </div>
     <!-- Page Body -->
     <div class="page-body">
                             ...
                             <div id="simpledatatable_wrapper">
                                 ...
                                 <table class="table table-hover table-bordered table-striped table-condensed flip-content">
                                     ...
                                     <tr>
                                         ...
                                         <th class="center" style="width: 10%;">Mã</th>
                                         <th style="width: 10%;" class="center">Khuyến mãi</th>
                                         <th  class="center">Hết hạn</th>
                                         <th style="width: 15%;" class="center">Số lần sử dụng</th>
