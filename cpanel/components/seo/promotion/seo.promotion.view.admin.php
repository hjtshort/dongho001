    ...
    <div class="page-breadcrumbs breadcrumbs-fixed">
        <div class="buttons-task col-xs-12 col-md-4">
            <ul class="breadcrumb breadcrumbs-fixed">
                ...
                <li class="toast-title">Thiết lập khuyến mãi</li>
            </ul>
        </div>
        <div class="text-align-right text-align-left-xs col-xs-12 col-md-8">
            <a href="seo/promotion/add.html" class="btn btn-sky shiny">Thêm mới</a>
        </div>
    </div>
     <!-- Page Body -->
     <div class="page-body">
         ...
         <div class="col-xs-12 col-md-12">
             <div class="widget">
                 <div class="widget-header with-footer">
                     <span class="widget-caption">Thiết lập khuyến mãi</span>
                             ...
                             <div id="simpledatatable_wrapper">
                                 ...
                                 <table class="table table-hover table-bordered table-striped table-condensed flip-content">
                                     ...
                                     <tr>
                                         ...
                                         <th class="center" style="width: 10%;">Kéo thả</th>
                                         <th class="center" style="width: 10%;">Ngày bắt đàu</th>
                                         <th style="width: 10%;" class="center">Ngày kết thúc</th>
                                         <th  class="center">Số lượng mua được áp dụng</th>
                                         <th style="width: 7%;" class="center">Trạng thái</th>
                                     ...
                                     <tbody>
                                         ...
                                         <tr class="selectable">
                                             ...
                                             <td class="center">
                                                <input type="image" name="default" id="default_0" src="/html/images/green-ok.gif" style="height:16px;width:16px;">
                                             </td>
                                             <td class="center">
                                                 <div class="btn-group">
                                                     <button type="button"
