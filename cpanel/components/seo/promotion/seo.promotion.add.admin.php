        ...
        <div class="page-breadcrumbs breadcrumbs-fixed">
            <div class="buttons-task col-xs-12 col-md-6">
                <ul class="breadcrumb breadcrumbs-fixed">
                    ...
                    <li>Thêm thông tin khuyến mãi</li>
                </ul>
            </div>
                        ...
                        <div class="col-lg-8 col-sm-8 col-xs-12">
                            <div class="widget flat">
                                <div class="widget-header bordered-bottom bordered-themeprimary">
                                    <span class="widget-caption">Thêm thông tin khuyến mãi</span>
                                ...
                                <div class="widget-body widget-body-white">
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label for="inputTitle">Tiêu đề khuyến mãi<span class="text-danger">*</span></label>
                                            <div>
                                                <input name="news_title" type="text" id="inputTitle" class="form-control">                                 
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <label for="inputTitle">Trạng thái hoạt động<span class="text-danger">*</span> </label>
                                            <div>
                                                <select class="span4" style="width:100%;">
                                    ...
                                    <div class="form-group">
                                        <div class="">
                                            <label for="inputTitle">Đặt hạng áp dụng khuyến mãi<span class="text-danger">*</span></label>                 
                                            <div style="margin-left:30px;">
                                                <input type="radio" value="1"><label for="" style="margin-top:-5px;margin-left:2px;">Áp dụng theo ngày</label>
                                            </div >  
                                            <div style="margin-left:30px;">
                                                <input type="radio" value="1"><label for="" style="margin-top:-5px;margin-left:2px;">Áp dụng theo lượt mua</label>
                                            </div>      
                                            <div class="checkbox" style="margin-left:30px;">
                                                    <label>
                                                        <input type="checkbox" class="colored-warning">
                                                        <span class="text"> Không áp dụng chương trình khuyến mãi này với các chương trình khác</span>
                                                    </label>
                                            </div>                                           
                                        </div>                                      
                                    </div>
                                     <div class="form-group">
                                        <label for="inputTitle">Kiểu khuyến mãi<span class="text-danger">*</span></label>
                                            <div style="margin-left:30px; font-weight:bold;">
                                                <label for="" style="font-weight:bold;">Khuyến mãi theo đơn hàng</label>
                                            </div>
                                            <div style="margin-left:30px;">
                                                <input type="radio" value="1"><label for="" style="margin-top:-5px;margin-left:2px;"> Miễn phí vận chuyển cho đơn hàng mua trên X sản phẩm.</label>
                                            </div>  
                                            <div style="margin-left:30px;">
                                                <input type="radio" value="1"><label for="" style="margin-top:-5px;margin-left:2px;">Miễn phí vận chuyển cho đơn hàng có trị trên X vnđ.</label>
                                            </div>      
                                            <div style="margin-left:30px;">
                                                <input type="radio" value="1"><label for="" style="margin-top:-5px;margin-left:2px;">Giảm giá cho đơn hàng có giá trị trên X vnđ.</label>
                                            </div> 
                                            <div style="margin-left:30px;">
                                                <input type="radio" value="1"><label for="" style="margin-top:-5px;margin-left:2px;"> Tặng quà cho đơn hàng có giá trị trên X vnđ.</label>
                                            </div> 
                                            <div style="margin-left:30px; font-weight:bold;">
                                                <label for="" style="font-weight:bold;">Khuyến mãi theo đơn hàng</label>
                                            </div>
                                            <div style="margin-left:30px;">
                                                <input type="radio" value="1"><label for="" style="margin-top:-5px;margin-left:2px;"> Mua X sản phẩm tặng 1 sản phẩm cùng loại.</label>
                                            </div> 
                                            <div style="margin-left:30px;">
                                                <input type="radio" value="1"><label for="" style="margin-top:-5px;margin-left:2px;"> Mua X sản phẩm tặng Y sản phẩm khác.</label>
                                            </div> 
                                            <div style="margin-left:30px;">
                                                <input type="radio" value="1"><label for="" style="margin-top:-5px;margin-left:2px;"> Giảm giá sản phẩm khi mua số lượng lớn.</label>
                                            </div> 
                                            <div style="margin-left:30px;">
                                                <input type="radio" value="1"><label for="" style="margin-top:-5px;margin-left:2px;"> Giảm giá cho tất cả các sản phẩm thuộc danh mục.</label>
                                            </div>
                                            <div class="form-group">
                                                <div class="">
                                                     <label for="inputTitle">Thông báo hiển thị</label>                 
                                                <div>
                                                     <textarea name="message" class="span7" rows="4" style="width:50%;"></textarea>
                                                </div >   
                                            </div>
                                        </div>
                                     </div>
