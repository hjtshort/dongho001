        	...
        	<div class="buttons-task col-xs-12 col-md-4">
                <ul class="breadcrumb breadcrumbs-fixed">
                    <li>
                        ...
                        <li class="toast-title">Cấu hình tiền tuệ</li>
                    </li>                
                </ul>
            </div>
            <div class="text-align-right text-align-left-xs col-xs-12 col-md-8">
                <a href="sitesetting/currency/add.html" class="btn btn-sky shiny">Thêm mới</a>
            </div>
        </div>
    </div>
    <!-- Page Body -->
                                ...
                                <div id="simpledatatable_wrapper">
                                    ...
                                    <table class="table table-hover table-bordered table-striped table-condensed flip-content">
                                        ...
                                        <tr>
                                            ...
                                            <th>Mã tiền tệ</th>
                                            <th class="center" style="width: 10%;">Tên</th>
                                            <th class="center" style="width: 10%;">Hiển thị</th>
                                            <th style="width: 10%;" class="center">Tỉ giá</th>
                                            <th style="width: 7%;" class="center">Tình trạng</th>
                                            <th style="width: 7%;" class="center">Ngày cập nhật</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="selectable">
                                                ...
                                                <td class="center uniformjs">
                                                    <span class="glyphicons btn-action single shield" style="margin-right: 0;"><i></i></span>
