        	...
        	<div class="buttons-task col-xs-12 col-md-4">
                <ul class="breadcrumb breadcrumbs-fixed">
                    <li>
                        ...
                        <li class="toast-title">Chuyển hướng 301</li>
                    </li>                
                </ul>
            </div>
            <div class="text-align-right text-align-left-xs col-xs-12 col-md-8">
                <a  class="btn btn-sky shiny" id="add">Thêm mới</a>
            </div>
        </div>
    </div>
    <!-- Page Body -->
                                ...
                                <div id="simpledatatable_wrapper">
                                    ...
                                    <table class="table table-hover table-bordered table-striped table-condensed flip-content">
                                        ...
                                        <tr>                        
                                            ...
                                            <th>Địa chỉ url</th>
                                            <th class="center">Chuyển hướng tới</th>
   ...
   $('#append').append(
    "<tr class='selectable'>"+
        ...
        "<td class='center uniformjs'>"+
            "<input name='news_title' type='text' id='inputTitle' class='form-control' style='width:100%;' placeholder='Kích để nhập địa chỉ url'>"+	
        "</td>"+
        "<td class='center uniformjs'>"+
            "<input name='news_title' type='text' id='inputTitle' class='form-control' style='width:100%;' placeholder='Kích để nhập url chuyển hướng'>"+	
        "</td>"+
