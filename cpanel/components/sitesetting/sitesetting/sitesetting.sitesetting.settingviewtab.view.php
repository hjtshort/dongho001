...
<link href="<?= $conf['template_admin']; ?>/assets/css/product-features.css" rel="stylesheet"/>
<link href="<?= $conf['template_admin']; ?>/assets/css/style.css" rel="stylesheet"/>
<link href="<?= $conf['template_admin']; ?>/assets/css/glyphicons.css" rel="stylesheet"/>
<link href="<?= $conf['template_admin']; ?>/assets/css/wti-custom.css" rel="stylesheet"/>
<link href="<?= $conf['template_admin']; ?>/assets/css/404.css" rel="stylesheet"/>
<link href="<?= $conf['template_admin']; ?>/assets/css/404.css" rel="stylesheet"/>
