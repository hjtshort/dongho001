...
<div class="page-breadcrumbs breadcrumbs-fixed">
    <div class="buttons-task col-xs-12 col-md-4">
        <ul class="breadcrumb breadcrumbs-fixed">
            ...
            <li class="toast-title">Cấu hình vận chuyển </li>
        </ul>
    </div>
    <div class="text-align-right text-align-left-xs col-xs-12 col-md-8">
        <a href="sitesetting/shipping/add.html" class="btn btn-sky shiny">Thêm mới</a>
    </div>
</div>
 <!-- Page Body -->
 <div class="page-body">
     ...
     <div class="col-xs-12 col-md-12">
         <div class="widget">
             <div class="widget-header with-footer">
                 <span class="widget-caption">Danh sách phương thức vận chuyển</span>
                         ...
                         <div id="simpledatatable_wrapper">
                             ...
                             <table class="table table-hover table-bordered table-striped table-condensed flip-content">
                                 ...
                                 <tr>
                                     ...
                                     <th>Tên hiển thị</th>
                                     <th class="center" style="width: 20%;">Phương thức vận chuyển</th>
                                     <th class="center" style="width: 20%;">Thời gian giao hàng</th>
                                 ...
                                 <tbody>
                                     ...
                                     <tr class="selectable">
                                         ...
                                         <td>
                                            <label>
                                                <input type="textbox" style="width:50%;" value="1">
                                                <span class="text"></span>
                                            </label>
                                         </td>
                                         <td class="center">
