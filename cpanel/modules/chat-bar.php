        ...
        <ul class="contacts-list">
            <li class="contact">
                <div class="contact-avatar">
                    <img src="<?= $conf['template_admin']; ?>/assets/img/avatars/divyia.jpg" />
                </div>
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="<?= $conf['template_admin']; ?>/assets/img/avatars/Nicolai-Larson.jpg" />
                </div>
                <div class="contact-info">
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="<?= $conf['template_admin']; ?>/assets/img/avatars/John-Smith.jpg" />
                </div>
                <div class="contact-info">
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="<?= $conf['template_admin']; ?>/assets/img/avatars/Osvaldus-Valutis.jpg" />
                </div>
                <div class="contact-info">
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="<?= $conf['template_admin']; ?>/assets/img/avatars/Javi-Jimenez.jpg" />
                </div>
                <div class="contact-info">
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="<?= $conf['template_admin']; ?>/assets/img/avatars/Stephanie-Walter.jpg" />
                </div>
                <div class="contact-info">
            ...
            <li class="contact">
                <div class="contact-avatar">
                    <img src="<?= $conf['template_admin']; ?>/assets/img/avatars/Lee-Munroe.jpg" />
                </div>
                <div class="contact-info">
