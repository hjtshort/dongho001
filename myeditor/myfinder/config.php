...
function CheckAuthentication()
{
    ...
    session_start();
    return isset($_SESSION["wti"]);
}

// LicenseKey : Paste your license key here. If left blank, CKFinder will be
// fully functional, in demo mode.
$config['LicenseName'] = 'SuperWeb';
$config['LicenseKey'] = 'A2PJPBNMMYXFK1Q3BCYFKYQFFQFYUR3X';
...
*/
$baseUrl = '/data_setting/' . $_SERVER['SERVER_NAME'] . '/file_upload/';
