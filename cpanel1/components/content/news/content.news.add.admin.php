            ...
            <div class="innerLR">
                <div class="widget widget-2">
                    <div class="widget-head">
                        ...
                        <h4 class="heading glyphicons qrcode"><i></i>Thêm mới tin tức</h4>
                    ...
                    <div class="widget-body">
                        <div class="row-fluid">
                            ...
                            <div class="span9">
                            	<div class="controls">
                                    <input name="news_title" type="text" id="inputTitle" class="span6" value="" placeholder="">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span9">
                            	...
                            	<div class="fileupload fileupload-new" data-provides="fileupload">
                                	<input type="text" value="" class="span4" name="image_src" id="image_src">
                      	...
                      	<div class="row-fluid">
                            ...
                            <div class="span9">
                                <input name="image_note" type="text" id="inputTitle" class="span6" value="" placeholder="">
                                &nbsp;
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span5">
                                <div class="groupcheckbox">
                                    <input name="news_focus" type="checkbox" class="checkbox" value="1">
                                    Tin nổi bật&nbsp;
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span9">
                                <label class="groupcheckbox">
                                	<input name="news_display" type="checkbox" class="checkbox" value="1" checked="checked"> &nbsp; (Chọn mục này nếu bạn muốn ẩn / hiện bản tin)
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span9">                                
                                <textarea name="news_desc"></textarea>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span9">
                                <textarea name="news_detail"></textarea>
								<script type="text/javascript">
