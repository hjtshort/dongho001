<?php defined( '_VALID_MOS' ) or die( include("404.php") );
    ...
    class news_process extends content_category
    {
	    ...
	    function process_edit_news($danhmuc_id, $tieude, $motangan, $motachitiet, 
        ...
        {			
            ...
            if ($this->dbObj->SqlQueryInputResult($sql, array($danhmuc_id, $tieude, $motangan, $motachitiet, 
        ...
        case "news.edit";
			...
			if($validator->ValidateForm())
			{
				if($_POST["act"] == "save"){
					...
					$ngaysua			= $func->_formatdate(date("d/m/Y"));
					$filehinhanh 		= $_POST["image_src"];
					...
					if($news_process->process_edit_news($danhmuc_id, $tieude, $motangan, $motachitiet, 
					$ngaysua, $filehinhanh, $chuthichanh, $hienthi, $tinnoibat, $seo_tieudetrang, $seo_thetukhoa, $seo_themota, $news_id) <> FALSE){
