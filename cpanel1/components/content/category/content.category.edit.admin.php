    ...
    <div id="wrapper">	
        <div id="content">
            ...
            <div class="heading-buttons">
                <h3 class="glyphicons list"><i></i> Chỉnh sữa danh mục tin tức</h3>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="productDescriptionTab">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                	<div class="controls">
                                    	<input value="<?= $data["tieude"]; ?>" name="category_title" type="text" id="category_title" class="span6">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <input name="category_display" type="checkbox" class="checkbox" <?php if( $data["hienthi"] ) { echo "checked"; } ?> />
                        ...
                        <div class="tab-pane" id="productSeoTab">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <input name="category_seo_title" type="text" id="inputTitle" class="span6" value="<?= $data["seo_tieudetrang"]; ?>">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <input name="category_seo_keyword" type="text" id="inputTitle" class="span6" value="<?= $data["seo_thetukhoa"]; ?>">&nbsp;<span class="icon-question-sign" data-toggle="tooltip" data-placement="right" title=" Mô tả các từ khóa chính của website"></span>
                                    <div class="separator"></div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <textarea name="category_seo_desc" class="span6" rows="5"><?= $data["seo_themota"]; ?></textarea>
