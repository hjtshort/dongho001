<?php defined( '_VALID_MOS' ) or die( include("404.php") );
    ...
    class category_process extends content_category
    {
	    ...
	    function process_add_category($danhmuc_id, $danhmuccha, $tieude, $alias, $tomtat , $ngaythem, $ngaysua, $thutu, $hienthi, $luotxem, $seo_tieudetrang, $seo_thetukhoa, $seo_themota)
        {			
		    $sql = "INSERT INTO danhmuctintuc(
            ...
            if ($this->dbObj->SqlQueryInputResult($sql, array($danhmuc_id, $danhmuccha, $tieude, $alias, $tomtat , $ngaythem, $ngaysua, $thutu, $hienthi, $luotxem, $seo_tieudetrang, $seo_thetukhoa, $seo_themota)) <> FALSE) {
                return true;
            } else {
                return false;
            }
    ...
    */
    ...
    switch(@$_POST["hidden"]){
        ...
        case "category.add";
			...
			$validator->addValidation("category_title","minlen=3","Tên danh mục phải lớn hơn 3 ký tự");
			...
			if($validator->ValidateForm())
			{
				if($_POST["act"] == "save"){
					...
					$sort					= $func->process_getmaxid("danhmuctintuc", "thutu");			
					...
					if($category_process->process_add_category($category_id, $parent_category, $category_title, $alias, $category_desc, $date_add, $date_edit, $sort, $category_display, $num_view, $category_seo_title, $category_seo_keyword, $category_seo_desc) <> FALSE){
						...
						$func->_redirect($index_backend . "content/category/add.html");
						exit;
					} else {
