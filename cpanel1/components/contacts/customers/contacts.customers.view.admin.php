        ...
        <div class="innerLR">
            <div class="widget widget-2">
                <div class="widget-head">
                    <h4 class="heading glyphicons group"><i></i>Danh sách khách hàng</h4>
                    <div class="heading-buttons">
                        <div class="buttons pull-right"> <a href="#modal-simple" data-toggle="modal" class="btn btn-primary btn-icon glyphicons circle_question_mark"><i></i> Trợ giúp</a> <a href="contacts/customers/add.html" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i>Thêm mới</a> <a href="" class="btn btn-primary btn-icon glyphicons delete"><i></i> Xóa</a> </div>
                    ...
                    <table class="table table-bordered table-condensed table-striped table-primary table-vertical-center checkboxs js-table-sortable ui-sortable">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 7%;" class="center">Giới tính</th>
                        ...
                        <tbody>
                            <tr class="selectable">
                                ...
                                <td class="important">tommeoden Nguyen Tuân Kiệt</td>
                                ...
                                <td class="center"></td>
                                <td class="center">0916456434</td>
                                <td class="center">16/06/2014</td>
                    ...
                    <div class="separator top form-inline small">
                        <div class="pull-left">
                            <div class="checkboxs_actions hide pull-left" style="display: none;">
                                <label class="strong">Danh sách khách hàng được chọn:</label>
                                <select class="selectpicker dropup" data-style="btn-default btn-small" style="display: none;">
                                    <option>Xoá danh sách hàng được chọn</option>
                                    <option>Ẩn danh sách hàng được chọn</option>
                                    <option>Hiện danh sách hàng được chọn</option>
                                </select>
                            </div>
                        </div>
