            ...
            <div class="widget widget-2 widget-tabs">
                <div class="widget-head">
                    <ul>
                        ...
                        <li><a href="#productSeoTab" data-toggle="tab" class="glyphicons pie_chart"><i></i>Thiết lập SEO</a></li>                    </ul>
                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="productDescriptionTab">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                	<div class="controls">
                                        <input name="category_title" type="text" id="category_title" class="span6" value="<?= $data["tieude"]; ?>" placeholder="">
                        ...
                        <div class="tab-pane" id="productSeoTab">                
                            <div class="row-fluid">
                                ...
                                <div class="span9"><br>
                                    <input name="category_seo_title" type="text" id="category_seo_title" class="span6" value="<?= $data["seo_tieudetrang"]; ?>" placeholder="">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <input name="category_seo_keyword" type="text" id="category_seo_keyword" class="span6" value="<?= $data["seo_thetukhoa"]; ?>" placeholder="">
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span9">
                                    <textarea name="category_seo_desc" id="category_seo_desc" class="span6" rows="5"><?= $data["seo_themota"]; ?></textarea>
