...
<form id="validateSubmitForm" name="myForm" method="post">
                ...
                <div class="widget widget-2">
                    ...
                    <div class="widget-body">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span9">
                            	<div class="controls">
                                	<input name="product_properties_title" type="text" id="product_properties_title" class="span5">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span9">
                                <textarea name="product_properties_desc" class="span6" rows="5"></textarea>
                            </div>
                        </div>
                        <div class="row-fluid">
                            <div class="span2">	
    ...
    <input type="hidden" name="hidden" value="properties.add" />
