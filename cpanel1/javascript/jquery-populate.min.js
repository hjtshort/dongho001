        ...
        for (var e = 0; e < elements.length; e++) {
            ...
            switch (d.type || d.tagName) {
                ...
                case 'select-multiple':
                    ...
                    break;
				case 'file':
					//$(d).attr('src', "/files/images/" + c.toString());
					$(d).after($('<br><a class="preview glyphicons picture" href="#previewModal" role="button" class="" data-toggle="modal" data-src="/files/images/'+c.toString()+'"><i></i>'+c.toString()+'</a>'));
                    break;
                case 'select':
                case 'select-one':
